...
package object entities {
  ...
  implicit class RichEntity(val entity: Entity) extends AnyVal {
    ...
    def save[T <: IdRev: Manifest: JsonFormat](component: T)(implicit manager: EntityManager): Try[T] =
      manager.saveComponent(entity, component)

    /** Removes the given component to the entity */
    def remove[T <: IdRev: Manifest: JsonFormat](component: T)(implicit manager: EntityManager): Try[Boolean] =
    ...
    def has[T: Manifest: JsonFormat](component: T)(implicit manager: EntityManager): Try[Boolean] =
      manager.hasComponent(entity, component)

    /** Gets the component of the given type attached to the entity if any */
    def get[T: Manifest: JsonFormat](implicit manager: EntityManager): Try[Option[T]] =
